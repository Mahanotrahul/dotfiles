# Generated by Powerlevel10k configuration wizard on 2022-02-26 at 19:57 IST.
...
#    (( VCS_STATUS_HAS_UNSTAGED == -1 )) && res+=" ${modified}─"
  ...
  function prompt_cluster_name() {
	  c_name=$(~/.cluster-zsh.sh)
	  p10k segment -b 4 -f '#000000' -t $c_name
  }
